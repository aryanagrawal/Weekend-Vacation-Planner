...
public class AirportAutocompleteResponse {
  ...
  public AirportAutocompleteResponse value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public AirportAutocompleteResponse label(String label) {
    this.label = label;
    return this;
  }
   ...
   * @return label
  **/
  @ApiModelProperty(required = true, value = "The name of this airport, in UTF-8 format, prefixed with the name of the city if it is not already incorporated in the name of the airport, and appended with the location's <a href=\"https://en.wikipedia.org/wiki/International_Air_Transport_Association_airport_code\">IATA code</a> (as in value), enclosed in square brackets.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AirportAutocompleteResponse airportAutocompleteResponse = (AirportAutocompleteResponse) o;
    return Objects.equals(this.value, airportAutocompleteResponse.value) &&
        Objects.equals(this.label, airportAutocompleteResponse.label);
  }
